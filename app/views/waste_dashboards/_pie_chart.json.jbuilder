...
json.colors ['#81C4F1', '#4E4676', '#6AF9C4', "#007079", "#009BFF", "#F7E967", "#F27281", "#85DB2D", '#BDD4DE', '#E57A10', '#F2481D', '#354873', '#A23645']
...
json.set! :tooltip do
  json.pointFormat 'Quantity: <b>{point.y}<b/><br />Date Range Quantity: <b>{point.date_range_quantity}</b> <br />Total Quantity: <b>{point.total_quantity}</b> <br />Date Range Percentage: <b>{point.percentage:.2f} %</b><br /><br />Total Percentage: <b>{point.percentage_of_total:.2f} %</b> '
end
...
json.series [""] do |set|
  ...
  json.data level_quantity do |key, value|
    json.name 'Level ' + key.to_s
    json.y value
